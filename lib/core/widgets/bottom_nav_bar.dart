...
class HajiCareBottomNavBar extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Stack(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Center Slot: Reserved gap for elevated mic button
              ...
              // Elevated Center Mic / Voice Translator Button
  ...
  Widget _buildCenterMicButton(BuildContext context, bool isDark) {
    ...
    final iconColor = isDark ? AppColors.darkOnPrimary : Colors.white;
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Ink(
              ...
              child: Center(
                child: Icon(Icons.mic_rounded, size: 24, color: iconColor),
              ),
            ),
          ),
        ),
