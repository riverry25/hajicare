...
void main() {
  group('RotatingSyncButton Widget Tests', () {
    testWidgets('Renders sync button with circular shape and sync icon', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Center(child: RotatingSyncButton(onSync: () async {})),
          ),
        ),
      );
    ...
    testWidgets('Spins when tapped and triggers onSync callback', (
      tester,
    ) async {
      bool synced = false;
